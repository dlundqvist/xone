...
static int gip_gamepad_op_input(struct gip_client *client, void *data, u32 len)
{
	...
	input_report_key(dev, BTN_TRIGGER_HAPPY1, paddles & GIP_GP_BTN_P1);
	input_report_key(dev, BTN_TRIGGER_HAPPY2, paddles & GIP_GP_BTN_P2);
	input_report_key(dev, BTN_TRIGGER_HAPPY3, paddles & GIP_GP_BTN_P3);
	input_report_key(dev, BTN_TRIGGER_HAPPY4, paddles & GIP_GP_BTN_P4);
